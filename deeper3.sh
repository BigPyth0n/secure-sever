...
# =============================================
# نصب و تنظیم Netdata (با رفع مشکل دسترسی)
# =============================================
echo "🔄 نصب Netdata..."
...
check_success "Netdata نصب و تنظیم شد"
...
# =============================================
# نصب و تنظیم CrowdSec (با رفع مشکل داشبورد)
# =============================================
echo "🔄 نصب CrowdSec..."
...
# راه‌اندازی داشبورد
sudo cscli dashboard setup --listen 0.0.0.0:3000 --force

# فعال‌سازی سرویس‌ها
sudo systemctl enable --now crowdsec crowdsec-metabase-bouncer
sudo systemctl restart crowdsec
sudo ufw allow 3000/tcp
check_success "CrowdSec و داشبورد نصب شدند"
...
- برای CrowdSec: نام کاربری \`admin@crowdsec.net\` و رمز اولیه \`crowdsec\`  
