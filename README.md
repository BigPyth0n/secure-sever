...
```
sudo su - root -c "wget https://raw.githubusercontent.com/BigPyth0n/secure-sever/refs/heads/main/deep14.sh -O /tmp/deep14.sh && chmod +x /tmp/deep14.sh && /tmp/deep14.sh"
```
